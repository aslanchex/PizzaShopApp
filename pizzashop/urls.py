...
urlpatterns = [
    ...
    path('pizzashop/sign-in/', auth_views.LoginView.as_view(template_name='pizzashop/sign_in.html'), name='pizzashop-sign-in'),
    path('pizzashop/sign-out/', auth_views.LogoutView.as_view(next_page='/'), name='pizzashop-sign-out'),
